...
public class FilmWebController {
    ...
    // Constante para el mensaje de error "Film not found"
    private static final String FILM_NOT_FOUND_MESSAGE = "Film not found";
    ...
    public String showFilm(Model model, @PathVariable long id) {
        ...
        if(op.isPresent()) {
            ...
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, FILM_NOT_FOUND_MESSAGE);
        }
    }
