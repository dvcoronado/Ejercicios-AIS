...
public class Review {
    ...
    public boolean equals(Object o) {
        ...
        if (id == null || text == null || user == null) {
            throw new NullPointerException("Essential field(s) are null");
        }

        if ((film == null && review.film != null) || (film != null && !film.equals(review.film))) {
            return false;
        }

        return id.equals(review.id) && score == review.score && text.equals(review.text) && user.equals(review.user);
    }
