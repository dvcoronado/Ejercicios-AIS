...
import es.codeurjc.web.nitflex.service.exceptions.FilmPosterRetrievalException;
	...
	public Optional<FilmDTO> findOne(long id) {
	 ...
	 public InputStream getPosterFile(long id) {
        ...
        try {
            ...
            // Lanzamos la excepción personalizada con el mensaje adecuado y la causa original
            throw new FilmPosterRetrievalException(id, e);
        }
    }
